...
namespace FlightBookingSystem.Repository
{
    public class BookingRepository : IBookingRepository
    {
        ...
        public BookingRepository(FlightBookingDBContext dbContext, IExceptionRepository exceptionServices, IMailService mailService)
        {
        ...
        public int CancelBookingbyId(int Id)
        {
            ...
            try
            {
                ...
                mail.Subject = "Booking Cancellation Successful, FlightBooking";
        ...
        public int CreateNewBooking(Bookings bookings)
        {
            ...
            try
            {
                ...
                mail.To = customer.EmailId;
                mail.Subject = "Booking Successful, FlightBooking";
                string body = "Hai " + customer.FirstName +
        ...
        public int CheckInBooking(int Id)
        {
            ...
            try
            {
                ...
                response = StatusCodes.Status200OK;
                mail.To = customer.EmailId;
                mail.Subject = "CheckedIn Successfully, FlightBooking ";
                string body = "Hai " + customer.FirstName + "\n" +
